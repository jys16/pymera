                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item hidden-xs-down search-box"> <a
                            ...
                            <form class="app-search">
                                <input type="text" class="form-control" placeholder="Escriba y de Enter"> <a
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="#"
                                id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    ...
                                    class="hidden-md-down">Pepito Perez &nbsp;</span> </a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="?action=dashboard" aria-expanded="false"><i
                                    class="fa fa-tachometer"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="?action=perfil" aria-expanded="false"><i
                                    class="fa fa-user-circle-o"></i><span class="hide-menu">Perfil</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="?action=compras" aria-expanded="false"><i
                                    class="fa fa-shopping-basket"></i><span class="hide-menu">Compras</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="?action=registro_productos" aria-expanded="false"><i
                                    class="fa fa-cubes"></i><span class="hide-menu">Registro de productos</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="?action=ventas" aria-expanded="false"><i
                                    class="fa fa-money"></i><span class="hide-menu">Ventas</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="?action=reportes" aria-expanded="false"><i
                                    class="fa fa-line-chart"></i><span class="hide-menu">Reportes</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="" aria-expanded="false"><i
                                    class="fa fa-sign-out"></i><span class="hide-menu">Salir</span></a>
                        </li>
                    </ul>
                </nav>
                                ...
                                <div class="d-flex no-block">
                                    ...
                                    <div class="ms-auto">
                                        <ul class="list-inline text-center font-12">
                                            <li><i class="fa fa-circle text-success"></i> Producto 1</li>
                                            <li><i class="fa fa-circle text-info"></i> Producto 2</li>
                                            <li><i class="fa fa-circle text-primary"></i> Producto 3</li>
                                        </ul>   
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-4 no-block">
                                    <h5 class="card-title mb-0 align-self-center">Visitantes</h5>
                                    <div class="ms-auto">
                                ...
                                <ul class="list-inline mt-4 text-center font-12">
                                    ...
                                    <li><i class="fa fa-circle text-success"></i> Escritorio</li>
                                    <li><i class="fa fa-circle text-info"></i> Telefono</li>
                                </ul>
                            </div>
                        </div>
                    </div>
